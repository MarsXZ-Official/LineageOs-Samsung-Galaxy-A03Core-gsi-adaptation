...
> ⚠️ При скачивании GSI вы получите **архив**. Его **не нужно распаковывать полностью**, прошивать нужно **только файл super.img** (и boot.img, если он есть) внутри архива.
