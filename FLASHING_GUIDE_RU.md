...
> Его **не нужно полностью распаковывать** — распаковка потребуется только один раз.
>
> • На **Windows (Odin)**: просто прошивайте файл `LineageOs20/21.tar` как есть.
> • На **Linux / macOS (Heimdall)**: распакуйте `LineageOs20/21.tar`, и внутри вы получите
> `boot.img` (если присутствует) и `super.img` — именно их и нужно прошивать.
