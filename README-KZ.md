...
Егер сіз нұсқаулықты оқығаннан гөрі **көргенді** жөн көрсеңіз, толық орнату және бейімдеу процесінің бейне шолуы YouTube-та қолжетімді.

Бейнеролик **орыс тілінде** жазылған. Егер сіз орыс тілін білмесеңіз, оңай түсіну үшін YouTube-тағы **қазақша субтитрлерді** (немесе ағылшынша субтитрлерді) қосуға кеңес береміз.

**[YouTube-тағы толық бейне нұсқаулықты көру](https://youtu.be/JX0434AHy6A)**
...
## 💾 Адаптация қадамдары
[Қазақ тілінде көру үшін басыңыз](https://github.com/MarsXz8656/LineageOs-Samsung-Galaxy-A03Core-gsi-adaptation/blob/system/ADAPTATION_GUIDE_KZ.md)
